package com.dev.cisco.controller;
...
public class AlunoController {
	...
	public ResponseEntity<Page<Aluno>> findAll(@RequestBody(required=false)String nome, Pageable pageable){
	...
	public ResponseEntity<Aluno>addAluno(@RequestBody Aluno aluno) throws URISyntaxException{
		try {
